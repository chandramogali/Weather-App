...
import { UilArrowUp, UilArrowDown, UilTemperature,
  UilTear, UilWind, UilSun, UilSunset
  ...
  return (
    <div>
        ...
        <div className="flex flex-row items-center justify-center space-x-2 text-white text-sm py-3 ">
            ...
            <UilSun />
            <p className="font-light ">
            High:<span className="font-medium ml-1"> {`${(temp_max-273.15).toFixed()}°`} </span>
            </p>
            <p className="font-light">|</p>

            <UilSun />
            <p className="font-light ">
            Low:<span className="font-medium ml-1"> {`${(temp_min-273.15).toFixed()}°`}</span>
            </p>
